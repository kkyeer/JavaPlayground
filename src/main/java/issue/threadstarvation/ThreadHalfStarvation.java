 ...
 * @Modified By:
 */
public class ThreadHalfStarvation {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        new ThreadHalfStarvation().test();
    }

    private ExecutorService executorService = new ThreadPoolExecutor(10, 12,1, TimeUnit.MINUTES,
    ...
    public void test() throws ExecutionException, InterruptedException {
        ...
        for (Future<String> outerFuture : outerFutureList) {
            System.out.println(outerFuture.get() + ",consume " + (System.currentTimeMillis() - start) + "ms");
        }
